...
ucode /tmp/tests/https_state_cache.uc /usr/libexec/opl-netfleet-compat >"$work/state-cache.log" 2>&1
...
stage=plugin_toggle
ucode /tmp/tests/https_native_guest.uc plugin-unload >"$work/plugin-unload.log" 2>&1
ucode /tmp/tests/https_native_guest.uc plugin-load >"$work/plugin-load.log" 2>&1
stage=procd
