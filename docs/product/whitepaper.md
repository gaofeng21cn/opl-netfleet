...
NetFleet 面向 OpenWrt 提供模块化代理与网络管理。它把多个机场组织为同一套出口资源，在节点、机场和地区之间取得性能与稳定性的平衡，并在管理服务、代理核心或上游资源失效时让网络退回更低但仍可解释的能力层级。
...
服务依赖、系统配置与内置功能迁移的具体方向见[微内核组合方案](../proposals/microkernel-composition.md)。
