...
const healthy: StatusSnapshot = {
  ...
  providers: [
    { id: 'alpha', display_name: 'Alpha 正式机场', role: 'primary', billing: 'subscription', selected: true, available_region_count: 4, region_count: 5, available_count: 18, candidate_count: 20, best_delay_ms: 78, last_best_delay_ms: 78, average_best_delay_ms: 84, delay_sample_count: 24, quota: { state: 'available', remaining_bytes: gib(812.6) } },
    { id: 'beta', display_name: 'Beta 高级机场', role: 'primary', billing: 'subscription', selected: true, available_region_count: 5, region_count: 5, available_count: 16, candidate_count: 18, best_delay_ms: 102, last_best_delay_ms: 102, average_best_delay_ms: 118, delay_sample_count: 24, quota: { state: 'available', remaining_bytes: gib(526.3) } },
    { id: 'gamma', display_name: 'Gamma 备用机场', role: 'reserve', billing: 'buyout', selected: false, available_region_count: 3, region_count: 4, available_count: 8, candidate_count: 12, best_delay_ms: 168, last_best_delay_ms: 168, average_best_delay_ms: 168, delay_sample_count: 1, quota: { state: 'unknown' } },
  ],
  regions: [
