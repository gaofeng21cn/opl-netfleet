...
let bounded_file, script_version, bundled_version;



bounded_file = function(path, limit) {
...
script_version = function(source) {
...
bundled_version = function(directory) {
...
return { script_version, bundled_version };
};
