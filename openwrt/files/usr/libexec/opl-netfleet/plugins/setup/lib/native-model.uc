...
let validate_request, upstream_candidates;

const desired_source = context.use("models.subscriptions").desired_source;

validate_request = function(request, revision) {
...
upstream_candidates = function(interfaces) {
	const result = [];
	const own = {};
...
return { validate_request, upstream_candidates };
};
