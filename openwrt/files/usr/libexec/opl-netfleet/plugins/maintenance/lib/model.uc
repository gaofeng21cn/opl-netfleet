...
let profile_id, file_path, profile_referenced, valid_option, validate_backup, redact_line;
...
redact_line = function(text, secrets) {
	let line = `${text ?? ""}`;
...
return { BACKUP_FORMAT, MAX_PROFILE_BYTES, MAX_BACKUP_BYTES, profile_id, file_path, profile_referenced, validate_backup, redact_line };
};
