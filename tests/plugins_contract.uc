import { valid_id, descriptor_error, action_access } from "../openwrt/files/usr/libexec/opl-netfleet/core/plugins.uc";
...
for (let id in ["../test", "test/child", "test;id", "zashboard", "https-compat", "-test"])
	check(!valid_id(id), "unsafe or built-in ID rejected");
