...
const root='/src/openwrt/files/usr/libexec/opl-netfleet',pid=+ARGV[0];
...
const owner={owner:'https-compat',service:'opl-netfleet-compat',instance:'engine',user:'nobody'};
...
call('remove');lock.lock('u');lock.close();
